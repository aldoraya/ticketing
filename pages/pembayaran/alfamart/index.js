...
export default function Alfamart() {
    ...
    <button className="flex text-green-500 hover:text-green-600">
        ...
        <p className='pl-4'>Metode Pembayaran</p>
    </button>
    </a>
    </Link>
        <h2 className="py-5 font-bold text-2xl">Alfamart</h2>
    <main className="flex">
        <div className="w-3/5 h-max bg-white p-5">
            ...
            <div className="mt-6">
                <Image src="/alfamart.jpg" width={56} height={36} alt="alfamart" />
                <div className="relative">
                <p className="font-semibold text-gray-900">Informasi Penting:</p>
                <p className="text-md text-gray-700">Pastikan untuk tidak menutup halaman Pembayaran ketika pembayaranmu sedang diproses dengan Alfamart</p>
                </div>
            </div>
        </div>
